...
class MainActivity : AppCompatActivity() {
    ...
    internal var btn_logout: ImageView
    internal var txt_id: TextView
    internal var txt_nim: TextView
    internal var id: String
    internal var nim: String
    internal var sharedpreferences: SharedPreferences

    //a list to store all the products
    internal var productList: MutableList<User>
    ...
    companion object {
        ...
        private val URL_PRODUCTS = "http://172.16.10.57/tugasandroid/Api.php"
    }
