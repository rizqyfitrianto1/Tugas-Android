...
class Register : AppCompatActivity() {
    ...
    internal var pDialog: ProgressDialog
    internal var btn_register: Button
    internal var btn_login: TextView
    internal var textView: TextView
    internal var txt_nama: EditText
    internal var txt_nim: EditText
    internal var txt_password: EditText
    internal var txt_confirm_password: EditText
    internal var intent: Intent

    internal var success: Int = 0
    internal var conMgr: ConnectivityManager
